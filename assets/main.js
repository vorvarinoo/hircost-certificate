...
/***/ "./node_modules/just-phone-mask/dist/just-phone-mask.min.js":
/*!******************************************************************!*\
  !*** ./node_modules/just-phone-mask/dist/just-phone-mask.min.js ***!
  \******************************************************************/
/***/ (function(module) {
...
/***/ "./node_modules/justtabs/dist/just-tabs.min.js":
/*!*****************************************************!*\
  !*** ./node_modules/justtabs/dist/just-tabs.min.js ***!
  \*****************************************************/
/***/ (function(module) {

/*! For license information please see just-tabs.min.js.LICENSE.txt */
!function(t,s){ true?module.exports=s():0}(self,(()=>(()=>{"use strict";var t={d:(s,e)=>{for(var i in e)t.o(e,i)&&!t.o(s,i)&&Object.defineProperty(s,i,{enumerable:!0,get:e[i]})},o:(t,s)=>Object.prototype.hasOwnProperty.call(t,s)},s={};return(()=>{t.d(s,{default:()=>a});const e="color: #FF0000",i="jtabs",o="is-selected",n="is-visible";class a{#t=!1;#s=null;#e=null;#i=null;#o=null;#n=null;#a=null;#r=null;#h={startTabIndex:0};constructor(t=null,s){if(this.#s=t,this.#s)if(document.querySelectorAll(`[data-${i}="${this.#s}"]`).length>1)this.#l(`Selector data-jtabs="${this.#s}" already exists!`);else{this.#e=document.querySelector(`[data-${i}="${this.#s}"]`),this.#h=Object.assign(this.#h,s);try{this.#b(),this.#d(),this.#c()}catch(t){console.group("%cJustTabs error: ",e),this.#l(t),console.groupEnd()}}else this.#l("Name is a required parameter")}#b(){this.#i=this.#e.querySelector(`[data-${i}="nav"]`),this.#n=this.#i.querySelectorAll(`[data-${i}="control"]`),this.#o=this.#e.querySelectorAll(`[data-${i}="panel"]`),this.#n.length===this.#o.length?(this.#h.startTabIndex>=this.#n.length||this.#h.startTabIndex<0?(console.log("%c"+`The starting index must be in the range from 0 to ${this.#n.length-1}. Index "0" applied.`,e),this.#a=this.#h.startTabIndex=0):this.#a=this.#h.startTabIndex,this.#h.activeIndex=this.#a,this.#i.setAttribute("role","tablist"),this.#n.forEach(((t,s)=>{t.setAttribute("role","tab"),t.setAttribute("tabindex","-1"),t.setAttribute("id",`jt-${this.#s}-${s+1}`)})),this.#n[this.#h.startTabIndex].removeAttribute("tabindex"),this.#n[this.#h.startTabIndex].setAttribute("aria-selected","true"),this.#n[this.#h.startTabIndex].classList.add(o),this.#o.forEach(((t,s)=>{t.setAttribute("role","tabpanel"),t.setAttribute("tabindex","-1"),t.setAttribute("aria-labelledby",this.#n[s].id)})),this.#o[this.#h.startTabIndex].classList.add(n),this.#h.el=this.#e,this.#h.name=this.#e):this.#l("The count of buttons and panels does not match!")}#d(){this.#n.forEach((t=>{t.addEventListener("click",this.#u),t.addEventListener("keydown",this.#x)}))}#u=t=>{const s=this.#n[this.#a];t.currentTarget!==s&&(this.#r=this.#a,this.#a=Array.from(this.#n).indexOf(t.currentTarget),this.#T())};#x=t=>{const s=Array.from(this.#n).indexOf(t.currentTarget);switch(t.key){case"ArrowLeft":this.#n[s-1]&&this.switchTo(s-1);break;case"ArrowRight":this.#n[s+1]&&this.switchTo(s+1);break;case"ArrowDown":this.#o[s].focus();break;default:return}};#T(){this.#t||(this.#n[this.#r].setAttribute("tabindex","-1"),this.#n[this.#r].removeAttribute("aria-selected"),this.#n[this.#r].classList.remove(o),this.#o[this.#r].classList.remove(n),this.#n[this.#a].focus(),this.#n[this.#a].removeAttribute("tabindex"),this.#n[this.#a].setAttribute("aria-selected","true"),this.#n[this.#a].classList.add(o),this.#o[this.#a].classList.add(n),this.#h.activeIndex=this.#a,this.#p())}#I(t){this.#r=this.#a,t>=this.#n.length||t<0?(console.log("%c"+`The index must be in the range from 0 to ${this.#n.length-1}. Index "0" applied.`,e),this.#a=0):this.#a=t}#l(t=null){t&&console.error(t),this.#t=!0}#c(){this.#h.onInit&&"function"==typeof this.#h.onInit&&this.#h.onInit(this)}#p(){this.#h.onSwitch&&"function"==typeof this.#h.onSwitch&&this.#h.onSwitch(this)}getOptions(t=null){return t?this.#h[t]:this.#h}switchTo(t){t||0===t?(this.#I(t),this.#T()):console.log("%cThe index is required",e)}}})(),s.default})()));
...
/***/ "./node_modules/bs-grid/dist/bootstrap-grid.min.css":
/*!**********************************************************!*\
  !*** ./node_modules/bs-grid/dist/bootstrap-grid.min.css ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/justtabs/dist/just-tabs.min.css":
/*!******************************************************!*\
  !*** ./node_modules/justtabs/dist/just-tabs.min.css ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(0,flatpickr__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-flatpickr-time-delivery]', {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_libsCss_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/libsCss.js */ "./src/js/modules/libsCss.js");
...
/* harmony import */ var _modules_certificate_renderer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/certificate-renderer.js */ "./src/js/modules/certificate-renderer.js");
/* harmony import */ var _modules_settings_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/settings.js */ "./src/js/modules/settings.js");
...
/* harmony import */ var _modules_quiz_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/quiz.js */ "./src/js/modules/quiz.js");
...
/* harmony import */ var _modules_edit_section_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/edit-section.js */ "./src/js/modules/edit-section.js");
/* harmony import */ var _modules_price_line_drag_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/price-line-drag.js */ "./src/js/modules/price-line-drag.js");
/* harmony import */ var _modules_certificate_price_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/certificate-price.js */ "./src/js/modules/certificate-price.js");
/* harmony import */ var _modules_choices_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/choices.js */ "./src/js/modules/choices.js");
...
document.addEventListener('DOMContentLoaded', function () {
  (0,_modules_settings_js__WEBPACK_IMPORTED_MODULE_3__.initSiteSettings)();
  window.addEventListener('load', function () {
    (0,_modules_validate_js__WEBPACK_IMPORTED_MODULE_6__.validateForms)();
    (0,_modules_modal_js__WEBPACK_IMPORTED_MODULE_4__.initModals)();
    (0,_modules_slider_js__WEBPACK_IMPORTED_MODULE_5__.initSliders)();
    (0,_modules_quiz_js__WEBPACK_IMPORTED_MODULE_7__.initQuiz)();
    (0,_modules_tabs_js__WEBPACK_IMPORTED_MODULE_8__.initTabs)();
    (0,_modules_edit_section_js__WEBPACK_IMPORTED_MODULE_9__.initEditSection)();
    (0,_modules_price_line_drag_js__WEBPACK_IMPORTED_MODULE_10__.initPriceLineDrag)();
    (0,_modules_certificate_price_js__WEBPACK_IMPORTED_MODULE_11__.initCertificatePrice)();
    (0,_modules_choices_js__WEBPACK_IMPORTED_MODULE_12__.initChoices)();
  });
});

/***/ }),

/***/ "./src/js/modules/certificate-price.js":
/*!*********************************************!*\
  !*** ./src/js/modules/certificate-price.js ***!
  \*********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCertificatePrice: function() { return /* binding */ initCertificatePrice; }
/* harmony export */ });
var initCertificatePrice = function initCertificatePrice() {
  var priceDisplay = document.querySelector('[data-certificate-price]');
  var priceInputs = document.querySelectorAll('input[name="price-certificate"]');
  if (!priceDisplay || priceInputs.length === 0) return;
  var updatePrice = function updatePrice(value) {
    var formattedPrice = new Intl.NumberFormat('ru-RU').format(value) + ' ₽';
  ...
  var checkedInput = document.querySelector('input[name="price-certificate"]:checked');
  if (checkedInput) {
...
/***/ "./src/js/modules/certificate-renderer.js":
/*!************************************************!*\
  !*** ./src/js/modules/certificate-renderer.js ***!
  \************************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./state.js */ "./src/js/modules/state.js");
/**
...
// Обновление цвета фона
{
  ...
  field: 'color',
  updater: function updater(el, value) {
    if (value) {
...
var render = function render(data) {
  renderConfig.forEach(function (config) {
    document.querySelectorAll(config.selector).forEach(function (el) {
      var value = getNestedValue(data, config.field);
...
_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].addEventListener('change', function (e) {
  render(e.detail);
});
render(_state_js__WEBPACK_IMPORTED_MODULE_0__["default"].get());

/***/ }),

/***/ "./src/js/modules/choices.js":
/*!***********************************!*\
  !*** ./src/js/modules/choices.js ***!
  \***********************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
var initChoices = function initChoices() {
  var timeZone = document.querySelector('[data-choice-time-zone]');
  var timeDelivery = document.querySelector('[data-choice-time-delivery]');
  new choices_js__WEBPACK_IMPORTED_MODULE_0__["default"](timeZone, {
    searchEnabled: false,
    itemSelectText: ''
  });
  new choices_js__WEBPACK_IMPORTED_MODULE_0__["default"](timeDelivery, {
    searchEnabled: false,
    itemSelectText: '',
    classNames: {
...
/* harmony export */   observerConfig: function() { return /* binding */ observerConfig; },
/* harmony export */   sliderConfig: function() { return /* binding */ sliderConfig; },
/* harmony export */   smoothScrollConfig: function() { return /* binding */ smoothScrollConfig; },
...
/***/ "./src/js/modules/edit-section.js":
/*!****************************************!*\
  !*** ./src/js/modules/edit-section.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initEditSection: function() { return /* binding */ initEditSection; }
/* harmony export */ });
var initEditSection = function initEditSection() {
  var screen = document.querySelector('[data-screen="5"]');
  if (!screen) {
    return;
  }
  var saveButton = document.querySelector('[data-save].button-navigation--save');
  var allSections = screen.querySelectorAll('.quiz__top > .section5');
  var mainSection = Array.from(allSections).find(function (section) {
    return !section.hasAttribute('data-inputs-edit-client') && !section.hasAttribute('data-inputs-edit-order');
  });
  var clientInputs = screen.querySelector('[data-inputs-edit-client]');
  var orderInputs = screen.querySelector('[data-inputs-edit-order]');
  if (!mainSection || !saveButton || !clientInputs || !orderInputs) {
    return;
  }
  clientInputs.classList.add('hidden');
  orderInputs.classList.add('hidden');
  var showEditMode = function showEditMode(type) {
  ...
  var showViewMode = function showViewMode() {
    mainSection.classList.remove('hidden');
    saveButton.classList.remove('is-visible');
    clientInputs.classList.add('hidden');
    orderInputs.classList.add('hidden');
  };
  var resetEditMode = function resetEditMode() {
    showViewMode();
  };
  screen.addEventListener('click', function (evt) {
    var button = evt.target.closest('[data-edit-client], [data-edit-order]');
    if (!button) return;
    evt.preventDefault();
  ...
  document.addEventListener('quiz-step-changed', function (e) {
...
/* harmony import */ var baguettebox_js_dist_baguetteBox_min_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! baguettebox.js/dist/baguetteBox.min.css */ "./node_modules/baguettebox.js/dist/baguetteBox.min.css");
...
/* harmony import */ var hystmodal_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! hystmodal/css */ "./node_modules/hystmodal/dist/hystmodal.min.css");
/* harmony import */ var bs_grid__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! bs-grid */ "./node_modules/bs-grid/dist/bootstrap-grid.min.css");
/* harmony import */ var _style_main_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../style/main.scss */ "./src/style/main.scss");
...
var beforeOpenCallback = function beforeOpenCallback(modal) {
  switch (modal.openedWindow.id) {
    default:
      return;
  }
};
var afterCloseCallback = function afterCloseCallback(modal) {
  switch (modal.openedWindow.id) {
    default:
      return;
  }
...
var initModals = function initModals() {
  (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.initModal)('siteModal', 'data-hystmodal', {
...
/***/ "./src/js/modules/price-line-drag.js":
/*!*******************************************!*\
  !*** ./src/js/modules/price-line-drag.js ***!
  \*******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initPriceLineDrag: function() { return /* binding */ initPriceLineDrag; }
/* harmony export */ });
var initPriceLineDrag = function initPriceLineDrag() {
  ...
  priceLines.forEach(function (priceLine) {
    ...
    var handleMouseMove = function handleMouseMove(e) {
      ...
      e.preventDefault();
      var x = e.pageX - priceLine.offsetLeft;
    ...
    var handleTouchMove = function handleTouchMove(e) {
      if (!isDragging) return;
      var x = e.touches[0].pageX - priceLine.offsetLeft;
      var walk = (x - startX) * 1.5;
      priceLine.scrollLeft = scrollLeft - walk;
    };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initQuiz: function() { return /* binding */ initQuiz; }
/* harmony export */ });
/* harmony import */ var _state_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./state.js */ "./src/js/modules/state.js");

var screens = document.querySelectorAll('.quiz__screen.screen');
var steps = document.querySelectorAll('.timeline__step');
var currentStep = 1;
var totalSteps = screens.length;
var screenItems = Array.from(screens, function (screen) {
  return {
    el: screen,
    num: Number(screen.dataset.screen)
  };
});
var stepItems = Array.from(steps, function (stepEl) {
  return {
    el: stepEl,
    num: Number(stepEl.dataset.step)
  };
});
var updateUI = function updateUI(step) {
  var activeStep = step;
  for (var i = 0; i < screenItems.length; i += 1) {
    var screenItem = screenItems[i];
    var isActive = screenItem.num === activeStep;
    screenItem.el.classList.toggle('isActive', isActive);
    screenItem.el.hidden = !isActive;
  }
  for (var _i = 0; _i < stepItems.length; _i += 1) {
    var stepItem = stepItems[_i];
  ...
  document.dispatchEvent(new CustomEvent('quiz-step-changed', {
    detail: {
      step: step
    }
  }));
...
var initQuiz = function initQuiz() {
  document.querySelector('.timeline__nav').addEventListener('click', function (e) {
    var btn = e.target.closest('button');
    if (!btn) return;
    var step = parseInt(btn.closest('.timeline__step').dataset.step);
    goToStep(step);
  });
  ...
  document.addEventListener('change', function (e) {
    ...
    var label = input.closest('.input-color-picker');
    var swatch = label === null || label === void 0 ? void 0 : label.querySelector('.input-color-picker__color');
    var swatchColor = (swatch === null || swatch === void 0 ? void 0 : swatch.style.getPropertyValue('--input-color')) || getComputedStyle(swatch || input).getPropertyValue('--input-color');
    var color = (swatchColor === null || swatchColor === void 0 ? void 0 : swatchColor.trim()) || input.dataset.color;
    if (!color) return;

    // Сохраняем цвет в state вместо прямого изменения DOM
    _state_js__WEBPACK_IMPORTED_MODULE_0__["default"].set('color', color);
  });

  // Инициализация дизайна из swiper
  var initDesignTracking = function initDesignTracking() {
    var _window$swiperInstanc;
    var designSlider = (_window$swiperInstanc = window.swiperInstances) === null || _window$swiperInstanc === void 0 ? void 0 : _window$swiperInstanc['certificate-design'];
    if (!designSlider) return;
    var updateDesignFromSlider = function updateDesignFromSlider() {
      var activeSlide = designSlider.slides[designSlider.activeIndex];
      var img = activeSlide === null || activeSlide === void 0 ? void 0 : activeSlide.querySelector('img');
      var imageSrc = (img === null || img === void 0 ? void 0 : img.src) || '';
      if (imageSrc) {
        _state_js__WEBPACK_IMPORTED_MODULE_0__["default"].set('design.image', imageSrc);
      }
    };
  ...
  var initDefaultColor = function initDefaultColor() {
    var defaultColorInput = document.querySelector('input[name="color-picker"]:checked');
    if (!defaultColorInput) return;
    var label = defaultColorInput.closest('.input-color-picker');
    var swatch = label === null || label === void 0 ? void 0 : label.querySelector('.input-color-picker__color');
    var swatchColor = (swatch === null || swatch === void 0 ? void 0 : swatch.style.getPropertyValue('--input-color')) || getComputedStyle(swatch || defaultColorInput).getPropertyValue('--input-color');
    var color = (swatchColor === null || swatchColor === void 0 ? void 0 : swatchColor.trim()) || defaultColorInput.dataset.color;
    if (color) {
      _state_js__WEBPACK_IMPORTED_MODULE_0__["default"].set('color', color);
    }
  };
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initScrollObserver: function() { return /* binding */ initScrollObserver; }
/* harmony export */ });
/* harmony import */ var _configs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./configs.js */ "./src/js/modules/configs.js");

var scrollTopNode = document.querySelector('#scroll-top');
var siteTopNode = document.querySelector('#site-top');
var showScrolTop = function showScrolTop() {
  scrollTopNode.classList.add('scroll-top--show');
};
var hideScrolTop = function hideScrolTop() {
  scrollTopNode.classList.remove('scroll-top--show');
};
var initItemObserver = function initItemObserver(targetNode, observeNode, isTrueFn, isFalseFn, config) {
...
var initScrollObserver = function initScrollObserver() {
  initItemObserver(scrollTopNode, siteTopNode, showScrolTop, hideScrolTop, _configs_js__WEBPACK_IMPORTED_MODULE_0__.observerConfig.scrollTop);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initSiteSettings: function() { return /* binding */ initSiteSettings; }
/* harmony export */ });
...
/* harmony import */ var _configs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./configs.js */ "./src/js/modules/configs.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ "./src/js/modules/utils.js");
/* harmony import */ var _scroll_observer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scroll-observer.js */ "./src/js/modules/scroll-observer.js");





var initSiteSettings = function initSiteSettings() {
  (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.iosVhFix)();
  (0,_scroll_observer_js__WEBPACK_IMPORTED_MODULE_4__.initScrollObserver)();
  new smooth_scroll__WEBPACK_IMPORTED_MODULE_1__('a[href*="#"]', _configs_js__WEBPACK_IMPORTED_MODULE_2__.smoothScrollConfig);
  ['[data-gallery]'].map(function (item) {
    return baguettebox_js__WEBPACK_IMPORTED_MODULE_0__.run(item);
  });
};
...
var bindExternalControls = function bindExternalControls(swiper, sliderId) {
  if (!swiper || !sliderId) return;
  document.querySelectorAll("[data-to-slide=\"prev\"][data-slider=\"".concat(sliderId, "\"]")).forEach(function (btn) {
    btn.addEventListener('click', function () {
      return swiper.slidePrev();
    });
  });
  document.querySelectorAll("[data-to-slide=\"next\"][data-slider=\"".concat(sliderId, "\"]")).forEach(function (btn) {
    btn.addEventListener('click', function () {
...
var initSliders = function initSliders() {
  var mainSlider = (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.initSlider)('.main-first', _objectSpread({}, _configs_js__WEBPACK_IMPORTED_MODULE_2__.sliderConfig));
  if (mainSlider) {
    window.swiperInstances['main-first'] = mainSlider;
    bindExternalControls(mainSlider, 'main-first');
  }
  var certificateDesignSlider = (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.initSlider)('[data-slider-image]', _objectSpread(_objectSpread({}, _configs_js__WEBPACK_IMPORTED_MODULE_2__.sliderConfig.default), {}, {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectCoverflow],
    on: {
      progress: function progress() {
        this.slides.forEach(function (slide) {
          var progress = Math.abs(slide.progress);
          var img = slide.querySelector('.create-design__img:not(.create-design__img--detail)');
          var previewImg = slide.querySelector('.create-design__img--detail');
 ...
 */
var CertificateState = /*#__PURE__*/function (_EventTarget) {
  function CertificateState() {
    var _this;
    _classCallCheck(this, CertificateState);
    _this = _callSuper(this, CertificateState);
    _this.data = {
      design: {
        image: null
      },
  ...
  _inherits(CertificateState, _EventTarget);
  return _createClass(CertificateState, [{
    key: "set",
    value: function set(key, value) {
      ...
      this.dispatchEvent(new CustomEvent('change', {
        detail: _objectSpread({}, this.data)
      }));
    }
  }, {
    key: "get",
...
var certificateState = new CertificateState();
/* harmony default export */ __webpack_exports__["default"] = (certificateState);
...
/* harmony export */ });
/* harmony import */ var justtabs_dist_just_tabs_min_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! justtabs/dist/just-tabs.min.css */ "./node_modules/justtabs/dist/just-tabs.min.css");
/* harmony import */ var justtabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! justtabs */ "./node_modules/justtabs/dist/just-tabs.min.js");


var initTabs = function initTabs() {
  new justtabs__WEBPACK_IMPORTED_MODULE_1__('recipient-contacts', {
    startTabIndex: 1
  });
  new justtabs__WEBPACK_IMPORTED_MODULE_1__('delivery-date', {
    startTabIndex: 1
  });
};
...
/* harmony export */   isEscKey: function() { return /* binding */ isEscKey; },
/* harmony export */   lockScroll: function() { return /* binding */ lockScroll; },
/* harmony export */   sendData: function() { return /* binding */ sendData; },
/* harmony export */   unlockScroll: function() { return /* binding */ unlockScroll; }
/* harmony export */ });
/* harmony import */ var hystmodal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! hystmodal */ "./node_modules/hystmodal/dist/hystmodal.esm.js");
...
/* harmony import */ var _configs_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./configs.js */ "./src/js/modules/configs.js");
...
var lockScroll = function lockScroll() {
  if (!document.documentElement.classList.contains('is-lock-scroll')) {
    ...
    document.documentElement.style.setProperty('--page-offset-right', "".concat(offset, "px"));
...
var initModal = function initModal(name) {
  var handler = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'data-hystmodal';
  var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  if (!name) return;
  var config = Object.assign({}, _configs_js__WEBPACK_IMPORTED_MODULE_3__.modalConfig, {
    config: {
      linkAttributeName: handler
    }
  }, options);
  var modal = new hystmodal__WEBPACK_IMPORTED_MODULE_0__["default"](config);
...
var initSlider = function initSlider(name) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var defaultConfig = Object.assign({}, {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation]
  }, _configs_js__WEBPACK_IMPORTED_MODULE_3__.sliderConfig.default);
  var customConfig = Object.assign(defaultConfig, options);
  if (typeof name === 'string') {
    var sliderElement = document.querySelector(name);
    if (!sliderElement) return;
    return new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](sliderElement, customConfig);
  }
  return new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](name, customConfig);
};
var disableSubmitBtn = function disableSubmitBtn(form) {
  if (!form.querySelector('[type="submit"]')) return;
  form.querySelector('[type="submit"]').setAttribute('disabled', 'disabled');
};
var enableSubmitBtn = function enableSubmitBtn(form) {
  if (!form.querySelector('[type="submit"]')) return;
...
var sendData = function sendData(evt, url) {
  var isSendJSON = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
  var isOk = arguments.length > 3 ? arguments[3] : undefined;
  var isError = arguments.length > 4 ? arguments[4] : undefined;
  var errorNode = evt.target;
...
/* harmony import */ var just_phone_mask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! just-phone-mask */ "./node_modules/just-phone-mask/dist/just-phone-mask.min.js");
/* harmony import */ var _configs_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./configs.js */ "./src/js/modules/configs.js");
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ "./src/js/modules/utils.js");
...
var justValidateConfig = _configs_js__WEBPACK_IMPORTED_MODULE_2__.validateConfig.justValidate;
var isSendOk = function isSendOk() {
  window.hystmodal.siteModal.open('#send-ok-modal');
};
var isSendError = function isSendError(target) {
  target.classList.add(justValidateConfig.errorFormClass);
  setTimeout(function () {
    target.classList.remove(justValidateConfig.errorFormClass);
  }, _configs_js__WEBPACK_IMPORTED_MODULE_2__.validateConfig.errorTimeout);
};
var validateForms = function validateForms() {
  ...
  forms.forEach(function (form) {
    ...
    var validationRules = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"](formID, justValidateConfig);
    var requiredFields = document.querySelectorAll("".concat(formID, " [required]"));
    new just_phone_mask__WEBPACK_IMPORTED_MODULE_1__(_configs_js__WEBPACK_IMPORTED_MODULE_2__.validateConfig.mask);
    requiredFields.forEach(function (input) {
      switch (input.dataset.validate) {
        case 'email':
          validationRules.addField("".concat(formID, " [data-validate=\"email\"]"), [{
            rule: 'required',
            value: true,
          ...
          break;
        case 'phone':
          validationRules.addField("".concat(formID, " [data-validate=\"phone\"]"), [{
            rule: 'required',
            value: true,
            errorMessage: 'Поле обязательно для заполнения'
          }, {
            rule: 'minLength',
            value: document.querySelector("".concat(formID, " [data-validate=\"phone\"]")).dataset.mask.length,
            errorMessage: 'Введите телефон в формате +7 (---) --- -- --'
          }]);
          break;
        case 'message':
          validationRules.addField("".concat(formID, " [data-validate=\"message\"]"), [{
            rule: 'required',
            value: true,
            errorMessage: 'Поле обязательно для заполнения'
          }, {
          ...
          break;
        case 'confirm':
          validationRules.addField("".concat(formID, " [data-validate=\"confirm\"]"), [{
            rule: 'required',
            value: true,
          ...
          break;
        default:
          validationRules.addField("".concat(formID, " [data-validate=\"").concat(input.dataset.validate, "\"]"), [{
            rule: 'required',
            value: true,
            errorMessage: 'Поле обязательно для заполнения'
          }]);
    ...
    validationRules.onSuccess(function (evt) {
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.sendData)(evt, evt.target.action, false, isSendOk, isSendError);
    });
  });
};
...
/* harmony export */   getLockState: function() { return /* binding */ getLockState; },
...
/******/ 	__webpack_require__("./src/js/flatpickr.js");
/******/ 	__webpack_require__("./src/js/main.js");
/******/ 	// This entry module is referenced by other modules so it can't be inlined
/******/ 	__webpack_require__("./src/js/modules/certificate-price.js");
/******/ 	__webpack_require__("./src/js/modules/certificate-renderer.js");
/******/ 	__webpack_require__("./src/js/modules/choices.js");
/******/ 	__webpack_require__("./src/js/modules/configs.js");
/******/ 	__webpack_require__("./src/js/modules/edit-section.js");
/******/ 	__webpack_require__("./src/js/modules/libsCss.js");
/******/ 	__webpack_require__("./src/js/modules/modal.js");
/******/ 	__webpack_require__("./src/js/modules/price-line-drag.js");
/******/ 	__webpack_require__("./src/js/modules/quiz.js");
/******/ 	__webpack_require__("./src/js/modules/scroll-observer.js");
/******/ 	__webpack_require__("./src/js/modules/settings.js");
/******/ 	__webpack_require__("./src/js/modules/slider.js");
/******/ 	__webpack_require__("./src/js/modules/state.js");
/******/ 	__webpack_require__("./src/js/modules/tabs.js");
/******/ 	__webpack_require__("./src/js/modules/utils.js");
